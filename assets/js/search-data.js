...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%64%69%70%61%6F%6C%61@%6D%69%74.%65%64%75", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/danielladipaola", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=qvpSQS8AAAAJ", "_blank");
        },
      },{
        id: 'social-media_lab',
        title: 'Media_lab',
        section: 'Socials',
        handler: () => {
          window.open("https://www.media.mit.edu/people/dipaola/overview/", "_blank");
        },
      },{
      id: 'light-theme',
